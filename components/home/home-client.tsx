...
export function HomeClient({ featuredItems }: HomeClientProps) {
    ...
    const displayItems = featuredItems.length > 0 ? featuredItems : [
        { name: "Happy Bars", price: 6000, image: "/images/menu-items/happy-bars.png" },
        { name: "Single Sundae", price: 12000, image: "/images/menu-items/waffle-basket-single-sundae.png" },
        { name: "Jar Sundae", price: 20000, image: "/images/menu-items/jar-sundae.png" },
        { name: "Triple Sundae", price: 25000, image: "/images/menu-items/triple-sundae.png" },
    ]
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                            {displayItems.map((item: any, index: number) => (
                                ...
                                >
                                    ...
                                    <p className="text-brandBlue font-bold">{item.price ? parseInt(item.price).toLocaleString() : item.price}/=</p>
                                </div>
                            ))}
                        </div>
                        <Link
